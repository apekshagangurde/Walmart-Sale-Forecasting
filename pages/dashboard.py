...
st.title("Dashboard - Demand Forecasting")
...
features = ['weather', 'promotion', 'festival']
...
forecast_data['festival'] = 'None'  # Default value for festivals in the future dates
forecast_data_encoded = pd.get_dummies(forecast_data[['month', 'festival']])
